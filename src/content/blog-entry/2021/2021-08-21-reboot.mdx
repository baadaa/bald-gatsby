...
7. A few year passes. Hate the site. Start the cycle again.
...
"Fine," the inner critic eventually gives in. He goes "Forget about the fancy layout. Just show more design samples and call it a day." Seems reasonable. There are plenty of `indd`, `psd`, `sketch`, `figma` files, internal pitch decks in `pdf` and `pptx`, a long list of Zeplin and InVision links, and a sh!t ton of code repos all over the place. Oh wait, how do I make them more _presentable_ and _understandable_?
