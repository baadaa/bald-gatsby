...
Admittedly utterly ignorant in Node environment, I’d rather avoid going there but at this point it became evident that I’d have to do something outside the browser.
...
If I were to face similar needs in the future, I might want to add explicit feedback UI and would try to automate harvesting the target file names.
